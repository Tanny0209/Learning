 ...
 * They do basic math, but I had to watch out for INTEGER DIVISION: when both
 * operands of / are integers, C++ chops off the decimal part (no rounding!).
 * The modulus operator % gives the REMAINDER of a division instead of the
 * quotient. This lesson shows me both the pitfall and the fix.
 */
