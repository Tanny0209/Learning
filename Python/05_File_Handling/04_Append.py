# Purpose: shows me how to ADD new content to the END of a file with "a" (append) mode.

# "a" (append) mode opens a file and puts the cursor at the END of the file,
# so everything I write is added AFTER the existing content.
...
with open("Python/05_File_Handling/00_Text.txt","a") as file:
    ...
    # in the variable "data", but I usually ignore it).
