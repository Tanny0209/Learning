...
print("\n--- Greeting with String Concatenation ---")
...
print("Index of the first double space (-1 if not found):", text.find("  ")) #print the index of the first occurrence of double spaces in the string (-1 if not found)
...
marks.sort()
print("Marks sorted in ascending order:", marks) #sort the list of marks in ascending order and print it
