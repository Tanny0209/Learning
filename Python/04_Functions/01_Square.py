...
# A function lets us give a name to a piece of logic and call it any number
...
# the function call, which we can store in a variable.
...
# f-strings lets us hand the finished text back to the caller.
def greet(name):
